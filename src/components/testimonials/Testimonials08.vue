  ...
  <div class="container">
    ...
    <div class="row mt-5 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        ...
        <p class="h3 mt-3">"Far far away, behind the word mountains, far from the countries Vokalia and Consonantia."</p>
      ...
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        ...
        <p class="h3 mt-3">"Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean."</p>
      ...
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        ...
        <p class="h3 mt-3">"A small river named Duden flows by their place and supplies it with the necessary regelialia."</p>
